import { StyledNavButton, StyledNavContainer, StyledNavMenu } from "../styles/Nav.styles";
...
const Nav = forwardRef<HTMLDivElement, Props>(({ scrollToNextSection }: Props, ref: any) => {
